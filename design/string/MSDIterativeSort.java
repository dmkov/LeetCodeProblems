...
public class MSDIterativeSort {

    // This is iterative solution.
    // It can be replaced with the recursive approach - then we do not need to define k beforehand
    ...
    public static void main(String[] args) {
        MSDIterativeSort msdSort = new MSDIterativeSort();
